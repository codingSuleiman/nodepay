...
async def ping(proxy, token):
    ...
    # Randomizing the ping delay (jitter effect)
    jitter = random.uniform(0.8, 1.2)  # Random multiplier between 0.8 and 1.2
    adjusted_ping_interval = PING_INTERVAL * jitter
    ...
    # Sleep for the adjusted interval with random jitter
    await asyncio.sleep(adjusted_ping_interval)
